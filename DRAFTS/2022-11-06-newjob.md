...
---
# DRAFT: This post is very much a work in progress


# Why am I writing this?
Like many others, I've had a less than enjoyable past few years through the pandemic. In September 2022 I decided that I'd had enough of academia and that following the end of my postdoc contract I would be looking for a non-academic position. I'd applied for quite a few non-academic positions at the end of my PhD without success, but this time around I felt I had a better handle on what to do. As it turned out, a handful of applications for interesting jobs across a range of areas led to three invitations to interview and two offers within a month [from which I accepted an offer to work as an Energy Market Analyst](https://nitter.com/tscmacdonald/status/1589102283652227077) with Aurecon, a large engineering consulting firm.

Part of this success is almost certainly due to good timing. I suspect that the skills shortage means employers are unusually open to hiring smart people without specific experience right now (Inger Mewburn's The Thesis Whisperer blog has a [great post on this with good data](https://thesiswhisperer.com/2021/08/25/will-you-get-a-job-after-covid-has-wrecked-higher-education/) from 2021). 

At the same time, I've been thinking about my options outside academia since the start of my PhD and laying groundwork to make that transition easier (if I decided to do it). Some of my preparations for a possible non-academic future included:

* Developing new skills that could be useful commercially (e.g. learning to use Python/numpy/pandas/matplotlib for data analysis and presentation in my PhD)
* Building visible portfolios of work to demonstrate these and other skills ([GitHub](www.github.com/tscmacdonald), this website)
* Talking to ECR/PhD former colleagues that left academia for good jobs and trying to work out how they did it
* Talking to friends and family with recent experience on corporate hiring committees/interview panels, and trying to find out what they were looking for

The transition from academia to a non-academic job is a mystical thing to many PhDs and ECRs. When you work surrounded by PhDs, ECRs who were once PhDs, and academics who were once ECRs it can be hard to know what other options exist or how to find them. Until quite recently I was in a similar situation, but after a lot of trial-and-error and a lot of talking to non-academic friends and employers I think I have a better sense of how to navigate the process. I'd like to share that here.

## An anecdote from a few years back
In the final year of my PhD I was aware that there wasn't likely to be a job waiting for me at the end. At that time I was uncertain of how successful my PhD might look at the end (I'd just started writing!) and had no idea if I would be competitive for postdoc positions, so I began to look into non-academic positions. Knowing that there were few interesting positions for chemists in Australia and with little confidence that employers would care about my PhD, I applied for lots of entry-level grad programs and received no interviews and no human feedback. The whole thing was grim and demotivating.
...
At the time I wasn't able to apply any of this - I had a thesis to finish, and had stopped applying for jobs. But I kept what I'd learned in mind for later, thinking there was a good chance I'd find myself in the same position again.

# Q: I'm smart, flexible, and a specialist in something incomprehensible with zero commercial relevance. What can I realistically do with this?

It's common to hear university types say that a PhD teaches a lot of generally useful skills, and that doing one can lead to all sorts of exciting endeavours outside academia. I agree with the gist of this, but I also find these statements frustratingly vague and lacking in *actionable* information: what, exactly, might those exciting endeavours look like and how do I find them?

## A: It's probably got "analyst" in the title.
