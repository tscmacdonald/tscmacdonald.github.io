...
At the same time, I've been thinking about my options outside academia almost since the start of my PhD and trying to prepare to make that transition easier if I chose to do it. Some of my preparations for a possible non-academic future include 

* New skills (e.g. leaning Python/numpy/pandas/matplotlib during my PhD)
* Visible portfolios of nonacademic work demonstrating useful skills (github, this website)
* Talking to ECR/PhD former colleagues that left academia for good jobs
* Talking to friends and family involved in corporate management who sit on hiring committees/interview panels

The transition from academia to a non-academic job is a mystical thing to many PhDs and ECRs. When you work surrounded by PhDs, ECRs that were once PhDs, and academics that were once ECRs it can be hard to know what other options exist or how you might find them. Most PhDs and ECRs seem to have little idea of what jobs exist or how to get them. Until quite recently I was in a similar boat, but after a lot of trial-and-error and a lot of talking to non-academic friends and employers I think I have a much better sense of how to navigate the process. I'd like to share that. 
...
I filed these ideas away for future use, but with my thesis deadline looming I had no time to apply them at the time.

# Q: I'm smart, flexible, and a world-leading specialist in something incomprehensible with zero commercial relevance. What can I realistically apply for?

It's common to hear university types talk about how a PhD isn't just specialist training in a technical niche: that it actually teaches a lot of generally useful skills, and that doing one can lead to all sorts of exciting endeavours outside academia. I agree with the gist of this, but I also find these statements frustratingly vague and lacking in *actionable* information: what, exactly, might those 'exciting endeavours' look like and how do I find them?
